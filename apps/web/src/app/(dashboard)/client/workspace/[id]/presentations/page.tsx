    ...
    <div className="space-y-8 relative">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-4xl md:text-5xl font-display font-extrabold tracking-tighter text-white mt-3">Presentations</h1>
          <p className="text-white/50 text-sm mt-2">Create branded artist lineups to share with your clients</p>
        </div>
        <button
