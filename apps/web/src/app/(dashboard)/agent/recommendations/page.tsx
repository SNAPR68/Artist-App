  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Find new artists for your roster and client events.</p>
      </div>
      ...
      <section>
        ...
        {popular.length === 0 ? (
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 text-center">
            <p className="text-gray-500 text-sm">No popular artists data available yet.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {popular.map((a) => (
